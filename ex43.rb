  ...
  def initialize(start)
    @quips = [
	 ...
	 def central_corridor()
	   ...
	   puts "His clown cotume is flowing and moving around his body, wihch throws"
	   puts "off your aim. Your laster hits his costume but misses him entirely. This"
	   puts " makes him fly into an insane rage and blast you repeadtedly in the face until"
